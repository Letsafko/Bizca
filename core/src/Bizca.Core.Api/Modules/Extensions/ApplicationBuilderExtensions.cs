namespace Bizca.Core.Api.Modules.Extensions
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        public static IApplicationBuilder ConfigureSwagger(this IApplicationBuilder app, SwaggerConfigurationModel swaggerConfiguration, Action<SwaggerUIOptions> specificSetupAction)
        {
            app.UseSwagger();
            app.UseStaticFiles();
            app.UseSwaggerUI(c =>
        ...
        public static IApplicationBuilder ConfigureCors(this IApplicationBuilder app, CorsConfigurationModel corsConfiguration)
        {
