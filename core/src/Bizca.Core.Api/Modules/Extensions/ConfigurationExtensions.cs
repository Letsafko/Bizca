namespace Bizca.Core.Api.Modules.Extensions
{
    ...
    public static class ConfigurationExtension
    {
        ...
        /// <returns></returns>
        public static T GetConfiguration<T>(this IConfiguration configuration, string scheme = "Api:Features") where T : new()
        {
            IConfigurationSection featuresConfiguration = configuration.GetSection(scheme);
        ...
        /// </summary>
        /// <param name="configuration"></param>
        public static ApplicationInsightsConfigurationModel GetApplicationInsightsConfiguration(this IConfiguration configuration, string scheme = "Api:ApplicationInsights")
        {
