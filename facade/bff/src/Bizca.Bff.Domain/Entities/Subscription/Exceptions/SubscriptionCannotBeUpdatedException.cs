namespace Bizca.Bff.Domain.Entities.Subscription.Exceptions
{
    ...
    public sealed class SubscriptionCannotBeUpdatedException : DomainException
    {
        ...
        public SubscriptionCannotBeUpdatedException(string message, Exception innerException) : base(message,
            innerException)
        {
        }
        ...
        public SubscriptionCannotBeUpdatedException(SerializationInfo info, StreamingContext context) : base(info,
            context)
        {
        }
    }
