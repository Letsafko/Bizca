namespace Bizca.User.Domain.Entities.Channel.Exceptions
{
    ...
    public sealed class ChannelCodeConfirmationHasExpiredUserException : DomainException
    {
        ...
        public ChannelCodeConfirmationHasExpiredUserException(string message, Exception innerException) : base(message,
            innerException)
        {
        }

        public ChannelCodeConfirmationHasExpiredUserException(string message, string propertyName) : base(message,
            propertyName)
        {
        }

        public ChannelCodeConfirmationHasExpiredUserException(SerializationInfo info, StreamingContext context) : base(
            info, context)
        {
        }
    }
