...
{
    Task<Dictionary<ResultName, IEnumerable<dynamic>>> GetByPartnerIdAndChannelResourceAsync(int partnerId,
        string channelResource);

    Task<Dictionary<ResultName, IEnumerable<dynamic>>> GetByPartnerIdAndExternalUserIdAsync(int partnerId,
